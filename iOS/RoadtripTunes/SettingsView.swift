...
struct SettingsView: View {
    ...
    @AppStorage("roadtriptunes_showNotes") private var showNotes: Bool = true
    @AppStorage("roadtriptunes_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/roadtunes-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/roadtunes-app/terms.html")!)
